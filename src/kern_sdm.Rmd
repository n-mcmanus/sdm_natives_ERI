...
Now, we want to project the Maxent model predictions for each month to determine how suitability changes during the year. To do this, we'll first need to create rasters of average monthly values for each environmental variable used:
```{r}
