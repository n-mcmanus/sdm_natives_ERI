...
pptFiles <- list.files(
  ...
  path = here("data/bcm/bcm_future/MIROC45/resampled//"),
  ## only select winter ppt
...
writeRaster(pptStack_sum,
            here("data/bcm/bcm_future/MIROC45/resampled/ppt_winter_2070_2099_MIROC45.tif"))
...
## export mean rast
writeRaster(tmxStack_avg,
            here("data/bcm/bcm_future/MIROC45/resampled/tmx_summer_2070_2099_MIROC45.tif"))
```
