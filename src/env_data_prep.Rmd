...
In addition to quarterly rasters by water year, we'll also need to make quarterly rasters averaged over the entire time period. 
```{r}
## Avg of winter precip (summed)
pptFiles <- list.files(path=here("data/bcmv8/quarterly_avgs//"),
...
## Avg of summer tmx
tmxFiles <- list.files(path=here("data/bcmv8/quarterly_avgs//"),
                       pattern = "tmx",
                       full.names=TRUE)
