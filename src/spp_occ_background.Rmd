...
## Download/import
This first section will read in, filter, and export species occurrence data from GBIF and CalFlora.
...
purrr::map(.x=names, function(names) {
  ...
  sppOcc = read_csv(paste0(here("data/occ/combined_spp_occ//"), 
    ...
    ## test: remove vegbank
    dplyr::filter(!source %in% "vegbank")
